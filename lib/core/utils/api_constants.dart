...
class ApiConstants {
  ...
  static const String productsCheckAvailability =
      '/products'; // /{id}/check-availability
  ...
  static const String interiorProductsByStore =
      '/interior-products/by-store'; // /{storeId}
  static const String interiorProductsByCategory =
      '/interior-products/by-category'; // /{categoryId}
  ...
  // Cart Endpoints (Shein Products)
  static const String invoicesAddToCart = '/invoices/add-to-cart';
  static const String invoicesGetCart = '/invoices/cart';
  static const String invoicesUpdateCartItem =
      '/invoices/update-cart-item'; // /{itemId}
  static const String invoicesRemoveFromCart =
      '/invoices/remove-from-cart'; // /{itemId}
  static const String invoicesSelectAddress =
      '/invoices'; // /{id}/select-address
  static const String invoicesApplyCoupon = '/invoices'; // /{id}/apply-coupon
  static const String invoicesSubmitPayment =
      '/invoices'; // /{id}/submit-payment
  static const String invoicesGetStatus = '/invoices'; // /{id}/status
  ...
  static const String announcementsMarkRead =
      '/announcements'; // /{id}/mark-read
